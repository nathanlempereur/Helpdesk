<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $conn->prepare("SELECT Noma, Prenoma, passa FROM admins WHERE usernamea = ?");
        ...
        if ($stmt->num_rows > 0) {
            ...
            if ($mdp === $password_bdd) {
                ...
                writeLog('Connexion', "Connexion de {$nom} {$prenom} en Administrateur.");
                exit;
            } else {
...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-crimson w3-card" id="myNavbar">
            <h2 style="margin-left: 10px;" class="w3-left">Connexion à votre compte administrateur:</h2>
