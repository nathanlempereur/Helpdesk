...
<br><br><br>
<h1>La liste des administrateurs :</h1><br>

<div style="text-align: right; margin-bottom: 20px; padding: 20px;">
    <a href="ajoutAdministrateur.php" class="w3-button w3-green w3-round-large">
        <i class="fa fa-user-plus"></i> Ajouter un administrateur
    </a>
    <a href="supprimerAdministrateur.php" class="w3-button w3-green w3-round-large">
        <i class="fa fa-minus"></i> Supprimer un administrateur
    </a>
</div>
<table>
<?php
    ...
    while ($users = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo '<td>' . htmlspecialchars($users['noma']) . '</td>';
        echo '<td>' . htmlspecialchars($users['prenoma']) . '</td>';
        echo '<td>' . htmlspecialchars($users['maila']) . '</td>';
        echo '<td>' . htmlspecialchars($users['usernamea']) . '</td>';
        echo "</tr>";
    }
    $bdd = null;
